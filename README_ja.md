...
MIFARE Classicドライバーは、https://github.com/hepingood/mifare_classic を参照できます。

MIFARE Ultralightドライバーは、https://github.com/hepingood/mifare_ultralight を参照できます。

NTAG21xドライブはhttps://github.com/hepingood/ntag21x を参照できます
